...
const getInstructionsByGroup = (req, res) => {
  ...
  const sql = `SELECT *
               FROM db.instructions
               WHERE g_title = ? AND d_title = ? AND w_title = ?
               ORDER BY number;`;
...
module.exports = {getInstructions, getInstructionsByWorkshop, getInstructionsByDepartment, getInstructionsByGroup};
